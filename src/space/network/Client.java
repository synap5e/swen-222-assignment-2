...
public class Client {
	 ...
	 */
	public Client(String host, int port, World world, KeyBinding keyBinding, int prevId){
		this.world = world;
	 ...
	 */
	public Client(String host, int port, World world, KeyBinding keyBinding){
		this(host, port, world, keyBinding, -1);
	}
